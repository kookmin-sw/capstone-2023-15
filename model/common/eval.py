...
test_loader = DataLoader(test_set, shuffle=False, batch_size=1, **kwargs)
...
for ood in P.ood_dataset:
    ...
    if P.one_class_idx is not None:
        ...
        ood_test_set = get_dataset(P, dataset=ood, test_only=True, image_size=32, eval=ood_eval)
    ood_test_loader[ood] = DataLoader(ood_test_set, shuffle=False, batch_size=1, **kwargs)
